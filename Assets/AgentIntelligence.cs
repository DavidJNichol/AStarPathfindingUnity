...
public class AgentIntelligence : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        {
            Rest();
            //if stamina reaches max, exit rest
    ...
    //HEARING HAS A .008% CHANCE TO TRIGGER PER EVERY TICK PLAYER IS IN COLLIDER
    void Hearing()
    {
    ...
    void Communicate()
    {
        if (otherAgent.GetComponent<AgentIntelligenceII>().enemyFound)
        {
            enemyFound = true;
        }
    }
